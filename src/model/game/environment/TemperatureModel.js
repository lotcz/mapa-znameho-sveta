...
export const TEMPERATURE_COLD = 1.5;
export const TEMPERATURE_CHILLING = 3;
export const TEMPERATURE_OK = 7;
export const TEMPERATURE_WARM = 8.5;
...
TEMPERATURE_TYPE_NAMES[TEMPERATURE_TYPE_FREEZING] = 'mráz';
TEMPERATURE_TYPE_NAMES[TEMPERATURE_TYPE_COLD] = 'zima';
TEMPERATURE_TYPE_NAMES[TEMPERATURE_TYPE_CHILLING] = 'chladno';
TEMPERATURE_TYPE_NAMES[TEMPERATURE_TYPE_OK] = 'akorát';
