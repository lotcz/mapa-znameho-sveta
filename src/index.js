...
const location = game.resources.map.locations.createNode();
location.name = 'Location';
location.coordinates.set(550, 450);
const conn = location.connections.add();
conn.pathId.set(1);

const location2 = game.resources.map.locations.createNode();
...
const path = game.resources.map.paths.createNode();
...
const path2 = game.resources.map.paths.createNode();
...
game.resources.materials.add(material);
