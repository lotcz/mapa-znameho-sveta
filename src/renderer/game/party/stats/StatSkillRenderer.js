...
export default class StatSkillRenderer extends DomRendererWithSaveGame {
	...
	updateStat() {
		if (this.model.current.equalsTo(0)) {
			Pixies.addClass(this.container, 'd-none');
			return;
		} else {
			Pixies.removeClass(this.container, 'd-none');
		}
